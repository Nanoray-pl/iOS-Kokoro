...
public class FittableTableView: UITableView {
	...
	public init(frame: CGRect = .init(origin: .zero, size: UIScreen.main.bounds.size), style: UITableView.Style, scrollableContentBehavior: ScrollableContentBehavior = .scrollable) {
